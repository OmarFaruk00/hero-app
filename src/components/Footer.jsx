      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              We build productive apps that help you achieve your goals and enhance your daily productivity. 
              Discover amazing applications from our community.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © 2024 hero.io. All rights reserved. Built with ❤️ for productivity enthusiasts.
          </p>
        </div>
      </div>
    </footer>
